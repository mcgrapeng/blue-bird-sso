...
public class PageBean<T> implements Serializable {
    ...
    public static PageBean of(int currentPage, int numPerPage) {
        return new PageBean(currentPage, numPerPage
                , 0,
                Lists.newArrayList());
    }

    public static <T> PageBean of(int currentPage, int numPerPage, int totalCount, List<T> recordList) {
        return new PageBean(currentPage, numPerPage
                , totalCount,
                recordList);
    }
