 ...
 */
public class AutoLoginConfigurer<T extends LoginConfigurer<T, B>, B extends HttpSecurityBuilder<B>> extends AbstractHttpConfigurer<T, B> {

    private AutoAuthenticationFilter smsAuthenticationFilter;
    public AutoLoginConfigurer() {
        this.smsAuthenticationFilter = new AutoAuthenticationFilter();
    }
    ...
    public void configure(B http) {
        ...
        AutoAuthenticationFilter smsfilter = postProcess(smsAuthenticationFilter);
        //指定Filter的位置
    ...
    public AutoLoginConfigurer<T,B> loginSuccessHandler(LoginSuccessHandler authSuccessHandler){
